jQuery(document).ready(function ($) {
    ...
    $(".projectListText").hover(
        function () {
            ...
            const imageHeight = $(".listImage").outerHeight();
            const targetId = $(this).attr("href");
            const targetIndex = $(targetId).index();
            const translateValue = `translateY(${(-targetIndex * imageHeight)}px)`;
    ...
    $(".projectListText span").slideUp();
    $(".projectListText:first-child span").slideDown();
    $(".projectListText").hover(
        function () {
